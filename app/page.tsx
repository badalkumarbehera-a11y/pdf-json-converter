        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
            {user ? (
              ...
              <Link href="/extraction" passHref>
                <Button>Go to Extraction</Button>
              </Link>
            ) : (
              // Show sign in/up buttons if user is not authenticated
              <>
        ...
        <div className="max-w-7xl mx-auto">
          <section className="text-center py-20">
            ...
            <div className="flex flex-col sm:flex-row sm:gap-4 gap-2 justify-center items-center mb-12">
              {user ? (
                // If user is authenticated, show "Start Converting" that goes to extraction
                <Link href="/extraction" passHref>
                  <Button
                    size="lg"
                ...
                // If user is not authenticated, show sign up/in buttons
                <>
                  <Link href="/sign-up" passHref>
                    <Button
                      size="lg"
